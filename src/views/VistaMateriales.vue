...
<template>
  <div class="vista-materiales">
    <div class="intro">
      ...
      <p>Gastos universitarios agrupados por categoria.</p>
    </div>
    ...
    <div v-else class="empty">
      <p>No hay gastos registrados aun. Agrega copias, lapices o videobeam para ver el resumen.</p>
    </div>
  </div>
</template>
